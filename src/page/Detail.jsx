    ...
    >
      ...
      >
        ...
        >
          <span>
            ประเภทผลงาน :{" "}
            <span style={{ fontWeight: "bold" }}>{dataDetail?.typeOfWork}</span>
          </span>
          <div>
            วันเริ่มต้น :{" "}
            <span style={{ fontWeight: "bold" }}>
              {dataDetail?.status === "ไม่แสดง" ? "" : dataDetail?.startDate}
            </span>
          </div>
          <div>
            วันสิ้นสุดการแสดง :{" "}
            <span style={{ fontWeight: "bold" }}>
              {dataDetail?.status === "ไม่แสดง" ? "" : dataDetail?.endDate}
            </span>
          </div>
        </div>
        ...
        >
          ...
          <span>
            อีเมล :{" "}
            <span style={{ fontWeight: "bold" }}>test@amethyst-sols.com</span>
          </span>
        </div>
        ...
        >
          <span style={{ fontWeight: "bold", paddingTop: "15px" }}>
            {dataDetail?.details}
          </span>
          <h6>
